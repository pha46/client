...
function Series() {
     ...
     const fetchTrendingContent = () => {
       ...
       return axios.get(`${process.env.REACT_APP_BASE_URL}/api/popularSeries`, requestOptions)
         .then(response => {
     ...
     const handleSearch = async (page) => {
       ...
       if (searchQuery.trim() !== '' || searchQuery !== null) {
         ...
         try {
           const { data } = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/series`, requestOptions);
...
<>
<div>
<h2 style={{ fontWeight: 'normal' }}>TV Series</h2>
<div>
...
<div className="search-results">
            ...
            {loading ? (
              <div style={{display:"flex", fontSize:'large', justifyContent: 'center', alignItems:'center', width:'80%' , height: '50vh'}}>Search for TV series...</div>
          ) : (
            <div>
